<?php
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE simple SET title = '$title', description = '$description', anh = '$anh' WHERE id = '$id'";
		$query = mysql_query($sql);
...
<div class="container edit-simple">
	<div class="row">
		...
		<?php
			while ($rows = mysql_fetch_array($query)) {
				?>
					...
					<hr>
						<img src="../image/<?php echo $rows['anh']?>" alt="" width=40% style="padding: 10px 0px;">
					</div>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-offset-3 col-lg-6">
						<form enctype="multipart/form-data"  method="post" >
							...
							<a href="main.php?page_layout=simple" title="">
